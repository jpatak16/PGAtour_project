...
betting_results = data.frame(prop = c('Winner', 'Top 10', 'Make Cut', 'Miss Cut', 'Total'), 
                             ...
                             bets_won = c(nrow(best_win_bets %>% filter(M22_win==TRUE)),
                                          ...
                                          NA),
                             net_profit = c(round(sum(best_win_bets$result_1u_bet),2), round(sum(best_top10_bets$result_1u_bet),2),
                                            round(sum(best_make_cut_bets$result_1u_bet),2), round(sum(best_miss_cut_bets$result_1u_bet),2),
                                            NA))
